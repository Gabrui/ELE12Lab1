...
function calcular() {
    ...
    texto +="<tr><td>$V_{swr} \\text{ em aberto para frequencia máxima: }$</td><td>$"+Vswr1abertomax.toFixed(4)+"\\;m\\;\\; \\text{ou} \\;\\;"+Vswr2abertomax.toFixed(4) + "\\;m $</td></tr>";
    texto +="<tr><td>$V_{swr} \\text{ em aberto para frequencia mínima: }$</td><td>$"+Vswr1abertomin.toFixed(4)+"\\;m\\;\\; \\text{ou} \\;\\;"+Vswr2abertomin.toFixed(4) + "\\;m $</td></tr>";
    texto +="<tr><td>$V_{swr} \\text{ em curto para frequencia máxima: }$</td><td>$"+Vswr1curtomax.toFixed(4)+"\\;m\\;\\; \\text{ou} \\;\\;"+Vswr2curtomax.toFixed(4) + "\\;m $</td></tr>";
    texto +="<tr><td>$V_{swr} \\text{ em curto para frequencia mínima: }$</td><td>$"+Vswr1curtomin.toFixed(4)+"\\;m\\;\\; \\text{ou} \\;\\;"+Vswr2curtomin.toFixed(4) + "\\;m $</td></tr>";
    texto += "</table>";
